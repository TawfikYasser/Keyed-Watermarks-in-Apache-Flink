...
public class InternalTimeServiceManagerImpl<K> implements InternalTimeServiceManager<K> {
    ...
    public void advanceWatermark(Watermark watermark) throws Exception {
        for (InternalTimerServiceImpl<?, ?> service : timerServices.values()) {
            if (watermark.isKeyed()) {
                service.setKeyedWatermark(watermark.getKey(), watermark.getTimestamp());
                service.advanceKeyedWatermark(watermark.getTimestamp(), watermark.getKey());
            } else {
