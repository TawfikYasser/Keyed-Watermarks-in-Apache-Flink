...
public interface InternalTimerService<N> {
    ...
    long getKeyedWatermark(Object watermarkKey);

    void setKeyedWatermark(Object watermarkKey, long watermarkTs);

    boolean isKeyedWatermark();

    boolean isNonKeyedWatermark();
