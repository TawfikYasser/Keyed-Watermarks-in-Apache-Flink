...
public class KeyedOutputStreamOperator<T, KEY> extends KeyedStream<T, KEY> {
    ...
    protected KeyedOutputStreamOperator(
            DataStream<T> dataStream,
            Transformation<T> transformation,
            KeySelector<T, KEY> keySelector) {
        super(dataStream, transformation, keySelector);
    }
     ...
     */
    public KeyedOutputStreamOperator<T, KEY> name(String name) {
     ...
     */
    @PublicEvolving
    public KeyedOutputStreamOperator<T, KEY> uid(String uid) {
     ...
     */
    @PublicEvolving
    public KeyedOutputStreamOperator<T, KEY> setUidHash(String uidHash) {
     ...
     */
    public KeyedOutputStreamOperator<T, KEY> setParallelism(int parallelism) {
     ...
     */
    @PublicEvolving
    public KeyedOutputStreamOperator<T, KEY> setMaxParallelism(int maxParallelism) {
     ...
     */
    private KeyedOutputStreamOperator<T, KEY> setResources(
     ...
     * @return The operator with set minimum and preferred resources.
     */
    private KeyedOutputStreamOperator<T, KEY> setResources(ResourceSpec resources) {
     ...
     */
    @PublicEvolving
    public KeyedOutputStreamOperator<T, KEY> forceNonParallel() {
     ...
     */
    public KeyedOutputStreamOperator<T, KEY> setBufferTimeout(long timeoutMillis) {
     ...
     */
    @PublicEvolving
    private KeyedOutputStreamOperator<T, KEY> setChainingStrategy(ChainingStrategy strategy) {
     ...
     */
    @PublicEvolving
    public KeyedOutputStreamOperator<T, KEY> disableChaining() {
     ...
     */
    @PublicEvolving
    public KeyedOutputStreamOperator<T, KEY> startNewChain() {
     ...
     */
    public KeyedOutputStreamOperator<T, KEY> returns(Class<T> typeClass) {
     ...
     */
    public KeyedOutputStreamOperator<T, KEY> returns(TypeHint<T> typeHint) {
     ...
     */
    public KeyedOutputStreamOperator<T, KEY> returns(TypeInformation<T> typeInfo) {
     ...
     */
    @PublicEvolving
    public KeyedOutputStreamOperator<T, KEY> slotSharingGroup(String slotSharingGroup) {
     ...
     */
    @PublicEvolving
    public KeyedOutputStreamOperator<T, KEY> slotSharingGroup(SlotSharingGroup slotSharingGroup) {
        transformation.setSlotSharingGroup(slotSharingGroup);
        return this;
    }
     ...
     */
    @PublicEvolving
    public KeyedOutputStreamOperator<T, KEY> setDescription(String description) {
