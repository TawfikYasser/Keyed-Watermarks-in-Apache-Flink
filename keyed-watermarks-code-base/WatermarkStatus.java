...
public final class WatermarkStatus extends StreamElement {
    ...
    public WatermarkStatus(int status, Object key) {
        if (status != IDLE_STATUS && status != ACTIVE_STATUS) {
            throw new IllegalArgumentException(
                    "Invalid status value for WatermarkStatus; "
                            + "allowed values are "
    ...
    public boolean equals(Object o) {
        ...
        WatermarkStatus that = (WatermarkStatus) o;
        return status == that.status && Objects.equals(key, that.key);
    }
    ...
    public String toString() {
        return "WatermarkStatus{" + "status=" + status + ", key=" + key + '}';
    }
}
