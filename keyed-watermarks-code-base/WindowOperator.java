...
//    CustomFileHandler fileHandler;
    ...
    public WindowOperator(
            ...
            OutputTag<IN> lateDataOutputTag) throws IOException {
...
//        fileHandler = new CustomFileHandler("/home/tawfik/SSDData/NU/Research/a-flink-keyed-watermarks/SomeKeysUnordered/log4j2.log");
    }
                        ...
                        mergingWindows.addWindow(
                                ...
                                new MergingWindowSet.MergeFunction<W>() {
                                    ...
                                    public void merge(
                                        ...
                                        if (internalTimerService.isKeyedWatermark()) {
                                            if ((windowAssigner.isEventTime()
                                                    && mergeResult.maxTimestamp() + allowedLateness
                                                    <= internalTimerService
                                                    .getKeyedWatermark(key))) {
...
////                tags.append("END,"+internalTimerService.currentWatermark()+","+System.nanoTime()); // Non-Keyed
//                long n = System.nanoTime();
//                tags.append("END,"+internalTimerService.getKeyedWatermark(timer.getKey())+","+timer.getKey()+","+n); // Keyed
//                output.collect(outputTag, new StreamRecord<>(tags.toString()));
            }
        }
    ...
    protected boolean isWindowLate(W window) {
        if (internalTimerService.isKeyedWatermark()) {
            return (windowAssigner.isEventTime()
                    && (cleanupTime(window)
                    <= internalTimerService.getKeyedWatermark(getCurrentKey())));
        } else {
            return (windowAssigner.isEventTime()
    ...
    public class WindowContext implements InternalWindowFunction.InternalWindowContext {
        ...
        @Override
        public long currentKeyedWatermark(Object key) {
            return internalTimerService.getKeyedWatermark(key);
        }
    ...
    public class Context implements Trigger.OnMergeContext {
        ...
        public long getKeyedWatermark(Object watermarkKey) {
            return internalTimerService.getKeyedWatermark(watermarkKey);
        }

        public boolean isKeyedWatermark() {
            return internalTimerService.isKeyedWatermark();
        }
        ...
        public TriggerResult onElement(StreamRecord<IN> element) throws Exception {
            return trigger.onElement(
                    element.getValue(), element.getTimestamp(), window, this, getCurrentKey());
        }
    ...
    public class CustomFileHandler extends Handler implements Serializable {
        ...
        public CustomFileHandler(String filename) {
